...
<head>
	<title>Editor | ASFIRJ</title>
	<meta charset="utf-8">
	<meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate">
<meta http-equiv="Pragma" content="no-cache">
<meta http-equiv="Expires" content="0">
<meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="../../../plugins/images/favicon.png" type="image/x-icon">
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 base-login-container base-form-holder">
                <div class="form-holder">
                    <div class="bwt-logo">
                        AFRICAN SCIENCE FRONTIERS INITIATIES RESEARCH JOURNAL | <span>Editor</span>
                    </div>
...
<!-- 
    <fieldset class="form-group">
        ...
        <select name="" id="" class="form-control form-control-lg">
            <option value="">Selct Job Title</option>
            <option value="">Editor</option>
            <option value="">Editor</option>
        </select>
    </fieldset> -->
    <fieldset class="form-group">
        <!-- <a href="../../../Dashboard/""> <span class="btn btn-primary btn-md submit-btn" id="loginButton">Sign In</span></a> -->
        <input class="btn btn-primary btn-md submit-btn" id="loginButton" type="submit" value="Sign In" />
    </fieldset>
</form>
<!-- <p class="text-center forgotten-password">Don't have an Account | <a href="../Register/">Register</a></p> -->
    ...
    <script type="module" src="../../../js/routes/login.js?v=<?= time(); ?>"></script>
</body>


<!-- Mirrored from auth.mpharma.com/accounts/login/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Jul 2022 20:45:18 GMT -->
</html>