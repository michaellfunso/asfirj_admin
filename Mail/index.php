...
<body>
 ...
 <header class="topbar" data-navbarbg="skin5" id="topbar">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">News Letter Mailing List</h3>
                                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                  <!-- <select class="form-select shadow-none row border-top">
                                    ...
                                    <a href="../ComposeEmail/" type="submit" class="btn btn-github" style="border-radius: 25px; width: fit-content;">
                         ...
                         <div class="projects mb-4">
                                <div class="projects-inner">
                                   ...
                                   <tbody id="mailingListContainer"></tbody>
      ...
      <!-- ============================================================== -->
                ...
                <div class="projects mb-4" id="sendMail" style="display: none;">
                    ...
                    <form id="sendMail">
                        ...
                        <input type="hidden" id="editor" name="editor" readonly>
                          ...
                          <div class="d-md-flex mb-3" style="flex-direction: column;">
                            ...
                            <div>* All News Letter Subscribers</div>
            ...
            <!-- End Section  -->
             ...
             <div class="d-md-flex mb-6" style="flex-direction: column; align-items: center;">
              <button type="submit" class="btn btn-github" style="border-radius: 25px; width: fit-content;">
                ...
                <span style="padding-left:10px;">Send Email</span></button>
                </div>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" aria-hidden="true">
   ...
   <!-- End Modal  -->
    ...
    <script type="module" src="../js/routes/dashboard/mailingList.js?v=<?= time(); ?>"></script>
</body>
