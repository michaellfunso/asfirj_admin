      ...
      <body>
          ...
          <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
              ...
              <header class="topbar" data-navbarbg="skin5">
                  <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                      ...
                      <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                          ...
                          <!-- ============================================================== -->
                          <ul class="navbar-nav ms-center d-flex align-items-center">
            
                              <!-- ============================================================== -->
                              <!-- Search -->
                              <!-- ============================================================== -->
                              <li class=" in text-white ">
                                  BW Tech Global Logistics Servics PVT Limited -
                              </li>
                              <!-- ============================================================== -->
                              ...
                              <li>
                                  <a class="profile-pic" href="#">
                                      <!-- <img src="../plugins/images/users/" alt="user-img" width="36"
                                          class="img-circle"> -->
                                          <span class="text-white font-medium">
                                             Ukachukwu Amaji</span></a>
                              </li>
                              <!-- ============================================================== -->
                              <!-- User profile and search -->
                              <!-- ============================================================== -->
                      ...
                      <nav class="sidebar-nav">
                          <ul id="sidebarnav">
                              ...
                              <li class="sidebar-item">
                                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../Tools/"
                                      aria-expanded="false">
                                      
                                      <!-- <i class=" fas fa-shopping-basket" aria-hidden="true"></i> -->
                                      <i class="bi bi-tools"></i>
                                      <span class="hide-menu">Requisition of tools</span>
                                  </a>
                              </li>
                              <li class="sidebar-item">
                                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../Expenses/"
                                      aria-expanded="false">
                              ...
                              <li class="sidebar-item">
                                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../LeaveSchedule/"
                                      aria-expanded="false">
                                      <!-- <i class="fas fa-hands" aria-hidden="true"></i> -->
                                      <i class="bi bi-person"></i>
                                      <span class="hide-menu">Staff Leave / Welfare</span>
                                  </a>
                              </li>
                              <li class="sidebar-item">
                                  <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../Events/"
                                      ...
                                      <span class="hide-menu">Events / Calendar</span>
                                  </a>
                              </li>
              ...
              <div class="page-wrapper">
                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row">
                          <div class="col-md-12 col-lg-12 col-sm-12">
                              <div class="white-box">
                                  <div class="d-md-flex mb-3" style="justify-content: space-between;">
                                      <h3 class="box-title mb-0">Recent Events</h3>
                                      <button class="float-right btn btn-danger text-white" data-toggle="modal" data-target="#exampleModal" id="MOD_BTN">New Event</button>
                  ...
                  <!-- footer -->
                  <!-- ============================================================== -->
                  <footer class="footer text-center"> 2022 © BW Tech Global - all rights reserved
                  </footer>
                  <!-- ============================================================== -->
                  <!-- End footer -->
                  <!-- ============================================================== -->
          ...
          <script>
            $("#MOD_BTN").on("click", function(){
                ...
                $('#exampleModal').addClass("myModalNew");
        
            });
            $(".close").on("click", function(){
                $('#exampleModal').removeClass("myModalNew");
