          ...
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <div class="d-md-flex">
              <ol class="breadcrumb ms-auto">
                <li><a href="#" class="fw-normal">Inbox</a></li>
              </ol>
              <a href="../Logout/" target="_blank" class="btn btn-danger  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Logout</a>
            </div>
          </div>
        </div>
        <!-- /.col-lg-12 -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                <!-- <h3 class="box-title mb-0">Inbox</h3> -->
                
                <div class="expand-forum">
          ...
          <script type="module" src="../js/routes/inbox/getEmailList.js?v=<?= time(); ?>"></script>
