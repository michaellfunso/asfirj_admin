...
<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <body>
                              ...
                              <div class="white-box">
                                  <div class="d-md-flex mb-3">
                                      ...
                                      <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                        <label for="findSuthor">Search:</label>
                                          <input class="form-control shadow-none row border-top" placeholder="Find An Author" id="findAnAuthor"/>
                                  ...
                                  <div class="projects mb-4">
                                      ...
                                      <tbody id="AuthorsContainer"></tbody>
          ...
          <script type="module" src="../js/routes/authors/getAuthors.js?v=<?= time(); ?>"></script>
      </body>
