...
<head>
    ...
    <link rel="canonical" href="https://asfirj.org" />
    <!-- Favicon icon -->
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <style>
            ...
            .combine_file:hover{
                background-color:#e00196;
            }
            .combine_file{
                margin-left: 20px;
            }
            .combine_file, .dropdown-toggle {
                background:#80078b;
                min-width:150px;
                width: max-content;
                outline: none;
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <script
                        src="../plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js?v=<?= time(); ?>"></script>
                    <!--Wave Effects -->
                    ...
                    <script
                        src="../plugins/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js?v=<?= time(); ?>"></script>
